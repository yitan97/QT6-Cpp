...
#include <memory>
#include "../../../3-3QtParentChildRelationship/house.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_House_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_House_t qt_meta_stringdata_House = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_House[] = {
...
Q_CONSTINIT const QMetaObject House::staticMetaObject = { {
    ...
    qt_meta_stringdata_House.offsetsAndSizes,
    qt_meta_data_House,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_House_t,
        // Q_OBJECT / Q_GADGET
